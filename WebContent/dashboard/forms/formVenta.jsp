...
<!-- BOTON DEL MODAL -->
<a href="#" class="btn btn-danger  pull-right" data-toggle="modal" data-target="#formVenta"><strong>Registrar
		venta</strong></a>

<!-- MODAL FORM PROVEEDOR -->
<div class="modal fade" id="formVenta" tabindex="-1" role="dialog" aria-labelledby="formVentaLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header ">
				<h2 class="modal-title titulo" id="formVentaLabel">Registro
					de venta</h2>
					...
					<div class=" row justify-content-around">
						...
						<div class="col-md-5">
							...
							<div class="form-group">
								<label><strong style="color: red;">* </strong><strong> Nombre Venta</strong></label>
